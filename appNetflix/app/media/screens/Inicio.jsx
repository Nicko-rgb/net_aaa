...
import { View, Text, FlatList, ScrollView, TouchableOpacity, Image, Dimensions, RefreshControl } from 'react-native';
...
const Inicio = ({ categories, videos, bannerVideos, activeCategory, onCategoryChange, refreshing, onRefresh }) => {
